    ...
    >
      <div className="flex items-start justify-between gap-3 mb-2">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <span className={cn("text-[10px] font-semibold px-2 py-0.5 rounded-full border", source.color)}>
            {source.label}
          </span>
          <button
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <span className="ml-auto text-[10px] text-muted-foreground/40">{timeAgo(job.postedAt)}</span>
      </div>
    </div>
  );
}
